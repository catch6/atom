...
Atom 是一个企业级 Spring Boot/Spring Cloud Starter 组件库框架，基于 Spring Boot 4.0.5 + Spring Cloud 2025.1.0 + JDK 17+。
...
使用 `${revision}` 属性（当前 4.0.0）+ flatten-maven-plugin 实现 CI 友好版本。修改版本只需改根 pom.xml 中的 `<revision>` 属性。
...
- Spring Boot 4.0.5 / Spring Cloud 2025.1.0 / Spring Cloud Alibaba 2025.1.0.0
