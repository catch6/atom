...
|------|-----|------------|-------------|---------------------|
| 4.0+ | 25+ | 4.0+       | 2025.1.0    | 2025.0.0.0          |
...
不占用项目 parent 槽位,可继续使用 `spring-boot-starter-parent` 或自有 parent。
...
适用于希望复用 atom 构建配置 (编译、注解处理、插件管理) 的新项目。
...
<dependency>
  <groupId>cn.mindit</groupId>
  <artifactId>atom-spring-boot-starter-xxx</artifactId>
</dependency>
```
