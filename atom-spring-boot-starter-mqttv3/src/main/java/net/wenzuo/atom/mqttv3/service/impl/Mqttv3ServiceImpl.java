...
package net.wenzuo.atom.mqttv3.service.impl;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import net.wenzuo.atom.mqttv3.service.Mqttv3Service;
...
public class Mqttv3ServiceImpl implements Mqttv3Service {
	...
	public void send(String id, String topic, String message, int qos, boolean retained) {
		...
		try {
			applicationContext.getBean("mqttv3Client-" + id, MqttClient.class)
